...
sequenceDiagram
    ...
    Note right of browser: the browser executes code that makes POST request to the server
    ...
    Note right of browser: JavaScript updates local notes list and re-renders UI 
```
